...
- End-state scene rule: Victory/Defeat phai load `EndScene` rieng sau khi capture stats, khong dung popup/modal tren GameScene. EndScene can dark-neutral, clean, centered, asset-led; khong dung transparent green/red full-screen overlay, terminal map backdrop, hoac hop mau rong de trang tri.
